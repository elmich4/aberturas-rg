      ...
      {!vendedor && (
        <button
          onClick={() => {
            ...
            // Escuchar respuesta del iframe via postMessage
          ...
          onMouseEnter={e => { const el = e.currentTarget as HTMLButtonElement; el.style.transform = 'translateY(-2px)'; el.style.boxShadow = '0 8px 28px rgba(37,211,102,.6)' }}
          onMouseLeave={e => { const el = e.currentTarget as HTMLButtonElement; el.style.transform = 'translateY(0)'; el.style.boxShadow = '0 4px 20px rgba(37,211,102,.5)' }}
        >
